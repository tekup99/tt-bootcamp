...
# **Aşağıdaki değişkenler prepaid datasetinde var ama actionable değil**
...
print("\n=== Prepaid Test Set Model Performansı ===")
...
csv_path = os.path.join(RESULTS_DIR, "prepaid_counterfactual_results.csv")
